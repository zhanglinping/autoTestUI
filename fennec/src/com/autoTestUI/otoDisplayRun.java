...
public class otoDisplayRun extends UiAutomatorTestCase{
	...
	public boolean ClickByClass(String classname){
		return ClickByInfo(CLICK_CLASS,classname);
	}
	
	public boolean SetTextByClass(String classname,String text){
